...
/**
 * Created by rohit.arun.pathak on 2/22/2016.
 */
...
public class ShopViewAdapter extends RecyclerView.Adapter<ShopViewAdapter.ItemHolder>{
    ...
    @Override
    public ShopViewAdapter.ItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemCardView = layoutInflater.inflate(R.layout.shop_new, parent, false);
        return new ItemHolder(itemCardView, this);
    }

    @Override
    public void onBindViewHolder(ShopViewAdapter.ItemHolder holder, int position) {
    ...
    public static class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private ShopViewAdapter parent;
        private View cardView;
        ImageView imageView;
        String itemUri;

        public ItemHolder(View cardView, ShopViewAdapter parent) {
            super(cardView);
